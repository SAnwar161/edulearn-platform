...
import DiscussionForum, { DiscussionModalProps } from '@/components/discussion-forum'
...
const subjectIcons: Record<string, React.ReactNode> = {
  ...
  'o-accounting': <TrendingUp className="w-5 h-5" />,
  'o-compsci': <Brain className="w-5 h-5" />,
  'o-economics': <BarChart3 className="w-5 h-5" />,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            {selectedLesson ? (
              ...
              <div className="text-center py-12 text-gray-500 h-[600px] flex items-center justify-center">
                <div>
